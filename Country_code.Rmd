...
##### Question 1: Convert the name of a country of choice into five different languages of your choice. Use the world dataset. You can also use 'codelist' to look at different destinations. (Remove eval=FALSE)
...
##### Question 2: Find the sub-region name and code for the top 20 countries with the highest Dollar values. 
...
##### Question 3: Draw a map with 5 countries with different labels using geom_sf, geom_text and countryname (you have complete freedom over what countries you want to do)

##### Question 4: Draw a map that has each country named after the continent it belongs to and colored  by their continent. Make sure your map looks like an actual map (not grids, not axis, add a title, a caption, etc.)
