...
##### In addition to these origins and destinations, there are more destinations. Look at the codelist to see all of the different destinations that a country code or name may be converted to. 
...
##### countrycode can take in both country code and country name. What it does is, it converts either the country code or country name to whatever destination we want to convert it to. For countrycode, the origin and destination have to be put in and having to identify the origin (the code associated with the given data) is the hardest part.There are around 30 different origins and destinations for the type of countrynames and countrycodes. They are given below:
